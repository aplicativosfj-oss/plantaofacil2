...
--
-- Name: create_master_credential(text, text, text, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_master_credential(p_username text, p_password text, p_full_name text DEFAULT NULL::text, p_is_active boolean DEFAULT true) RETURNS uuid
...
CREATE FUNCTION public.generate_student_id() RETURNS character varying
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: get_student_basic_info(character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_student_basic_info(p_student_id character varying) RETURNS TABLE(student_id character varying, full_name character varying, avatar_url text, enrollment_status character varying)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT 
...
--
-- Name: purge_expired_trash_items(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.purge_expired_trash_items() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: set_student_id(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_student_id() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: update_master_password(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_master_password(p_credential_id uuid, p_new_password text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'extensions'
    AS $$
BEGIN
...
--
-- Name: validate_master_credentials(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_master_credentials(p_username text, p_password text) RETURNS TABLE(id uuid, username text, full_name text, is_valid boolean)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'extensions'
    AS $$
BEGIN
...
--
-- Name: deleted_items_trash; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.deleted_items_trash (
    ...
    auto_purge_at timestamp with time zone DEFAULT (now() + '30 days'::interval) NOT NULL,
...
--
-- Name: evolution_photos; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.evolution_photos (
    ...
    notes text,
    photo_type character varying(50) DEFAULT 'front'::character varying,
...
--
-- Name: freight_messages; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: freight_proposals; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: freight_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.freight_requests (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    client_id uuid NOT NULL,
    origin_neighborhood_id uuid,
    origin_address text NOT NULL,
    origin_reference text,
    destination_neighborhood_id uuid,
    destination_address text NOT NULL,
    destination_reference text,
    estimated_distance_km numeric,
    service_type character varying DEFAULT 'frete'::character varying NOT NULL,
...
--
-- Name: freight_settings; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.instructor_clients (
    ...
    responded_at timestamp with time zone,
    CONSTRAINT instructor_clients_link_status_check CHECK (((link_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('accepted'::character varying)::text, ('rejected'::character varying)::text])))
);
...
CREATE TABLE public.neighborhoods (
    ...
    city character varying DEFAULT 'Feijó'::character varying NOT NULL,
    state character varying DEFAULT 'AC'::character varying NOT NULL,
    zip_code character varying DEFAULT '69960-000'::character varying,
    is_active boolean DEFAULT true,
    created_at timestamp with time zone DEFAULT now()
);
...
CREATE TABLE public.personal_records (
    ...
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT personal_records_record_type_check CHECK (((record_type)::text = ANY (ARRAY[('max_weight'::character varying)::text, ('max_reps'::character varying)::text, ('max_volume'::character varying)::text, ('best_time'::character varying)::text])))
);
...
CREATE TABLE public.provider_vehicles (
    ...
    base_rate_per_km numeric DEFAULT 2.50 NOT NULL,
    fuel_consumption_km_per_liter numeric DEFAULT 10,
    min_rate numeric DEFAULT 30,
    photo_url text,
    is_available boolean DEFAULT true,
    availability_start_hour integer DEFAULT 6,
    availability_end_hour integer DEFAULT 22,
    availability_days integer[] DEFAULT '{1,2,3,4,5,6}'::integer[],
    notes text,
...
--
-- Name: deleted_items_trash deleted_items_trash_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deleted_items_trash
    ADD CONSTRAINT deleted_items_trash_pkey PRIMARY KEY (id);


--
-- Name: evolution_photos evolution_photos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.evolution_photos
    ADD CONSTRAINT evolution_photos_pkey PRIMARY KEY (id);
...
--
-- Name: freight_messages freight_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_messages
    ADD CONSTRAINT freight_messages_pkey PRIMARY KEY (id);


--
-- Name: freight_proposals freight_proposals_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_proposals
    ADD CONSTRAINT freight_proposals_pkey PRIMARY KEY (id);


--
-- Name: freight_proposals freight_proposals_request_id_provider_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_proposals
    ADD CONSTRAINT freight_proposals_request_id_provider_id_key UNIQUE (request_id, provider_id);


--
-- Name: freight_requests freight_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: freight_settings freight_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_settings
    ADD CONSTRAINT freight_settings_pkey PRIMARY KEY (id);


--
-- Name: freight_settings freight_settings_setting_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_settings
    ADD CONSTRAINT freight_settings_setting_key_key UNIQUE (setting_key);
...
--
-- Name: master_credentials master_credentials_username_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.master_credentials
    ADD CONSTRAINT master_credentials_username_unique UNIQUE (username);
...
--
-- Name: idx_deleted_items_auto_purge; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_deleted_items_auto_purge ON public.deleted_items_trash USING btree (auto_purge_at) WHERE (permanently_deleted_at IS NULL);
...
--
-- Name: profiles trigger_set_student_id; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_set_student_id BEFORE INSERT ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.set_student_id();


--
-- Name: freight_proposals update_freight_proposals_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_freight_proposals_updated_at BEFORE UPDATE ON public.freight_proposals FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: freight_requests update_freight_requests_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_freight_requests_updated_at BEFORE UPDATE ON public.freight_requests FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: freight_settings update_freight_settings_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_freight_settings_updated_at BEFORE UPDATE ON public.freight_settings FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: provider_vehicles update_provider_vehicles_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_provider_vehicles_updated_at BEFORE UPDATE ON public.provider_vehicles FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: evolution_photos evolution_photos_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.evolution_photos
    ADD CONSTRAINT evolution_photos_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: freight_messages freight_messages_receiver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_messages
    ADD CONSTRAINT freight_messages_receiver_id_fkey FOREIGN KEY (receiver_id) REFERENCES public.profiles(id);


--
-- Name: freight_messages freight_messages_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_messages
    ADD CONSTRAINT freight_messages_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.freight_requests(id) ON DELETE CASCADE;


--
-- Name: freight_messages freight_messages_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_messages
    ADD CONSTRAINT freight_messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.profiles(id);


--
-- Name: freight_proposals freight_proposals_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_proposals
    ADD CONSTRAINT freight_proposals_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.profiles(id);


--
-- Name: freight_proposals freight_proposals_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_proposals
    ADD CONSTRAINT freight_proposals_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.freight_requests(id) ON DELETE CASCADE;


--
-- Name: freight_proposals freight_proposals_vehicle_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_proposals
    ADD CONSTRAINT freight_proposals_vehicle_id_fkey FOREIGN KEY (vehicle_id) REFERENCES public.provider_vehicles(id);


--
-- Name: freight_requests freight_requests_accepted_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_requests
    ADD CONSTRAINT freight_requests_accepted_provider_id_fkey FOREIGN KEY (accepted_provider_id) REFERENCES public.profiles(id);


--
-- Name: freight_requests freight_requests_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_requests
    ADD CONSTRAINT freight_requests_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.profiles(id);


--
-- Name: freight_requests freight_requests_destination_neighborhood_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_requests
    ADD CONSTRAINT freight_requests_destination_neighborhood_id_fkey FOREIGN KEY (destination_neighborhood_id) REFERENCES public.neighborhoods(id);


--
-- Name: freight_requests freight_requests_origin_neighborhood_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_requests
    ADD CONSTRAINT freight_requests_origin_neighborhood_id_fkey FOREIGN KEY (origin_neighborhood_id) REFERENCES public.neighborhoods(id);


--
-- Name: freight_settings freight_settings_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.freight_settings
    ADD CONSTRAINT freight_settings_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.profiles(id);
...
--
-- Name: provider_vehicles provider_vehicles_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.provider_vehicles
    ADD CONSTRAINT provider_vehicles_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.profiles(id);


--
-- Name: provider_vehicles provider_vehicles_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.provider_vehicles
    ADD CONSTRAINT provider_vehicles_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: licenses Admins can insert licenses; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can insert licenses" ON public.licenses FOR INSERT WITH CHECK (public.is_admin_or_higher(auth.uid()));
...
CREATE POLICY "Admins can insert payments" ON public.payments FOR INSERT WITH CHECK (public.is_admin_or_higher(auth.uid()));
...
--
-- Name: freight_proposals Admins can manage all proposals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage all proposals" ON public.freight_proposals USING (public.is_admin_or_higher(auth.uid()));


--
-- Name: freight_requests Admins can manage all requests; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage all requests" ON public.freight_requests USING (public.is_admin_or_higher(auth.uid()));
...
--
-- Name: provider_vehicles Admins can manage all vehicles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage all vehicles" ON public.provider_vehicles USING (public.is_admin_or_higher(auth.uid()));


--
-- Name: freight_settings Admins can manage freight settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage freight settings" ON public.freight_settings USING (public.is_admin_or_higher(auth.uid()));


--
-- Name: freight_messages Admins can manage messages; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage messages" ON public.freight_messages USING (public.is_admin_or_higher(auth.uid()));


--
-- Name: neighborhoods Admins can manage neighborhoods; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage neighborhoods" ON public.neighborhoods USING (public.is_admin_or_higher(auth.uid()));
...
CREATE POLICY "Admins can manage tenant licenses" ON public.licenses USING ((public.is_admin_or_higher(auth.uid()) AND ((tenant_id = public.get_current_tenant_id()) OR public.is_master(auth.uid()) OR (tenant_id IS NULL))));
...
CREATE POLICY "Admins can manage tenant payments" ON public.payments USING ((public.is_admin_or_higher(auth.uid()) AND ((tenant_id = public.get_current_tenant_id()) OR public.is_master(auth.uid()) OR (tenant_id IS NULL))));
...
--
-- Name: freight_requests Clients can manage own requests; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Clients can manage own requests" ON public.freight_requests USING ((client_id = public.get_current_profile_id()));
...
--
-- Name: freight_proposals Clients can update proposal status; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Clients can update proposal status" ON public.freight_proposals FOR UPDATE USING ((request_id IN ( SELECT freight_requests.id
   FROM public.freight_requests
  WHERE (freight_requests.client_id = public.get_current_profile_id()))));


--
-- Name: provider_vehicles Clients can view approved vehicles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Clients can view approved vehicles" ON public.provider_vehicles FOR SELECT USING (((is_approved = true) AND (is_available = true)));
...
--
-- Name: freight_proposals Clients can view proposals for own requests; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Clients can view proposals for own requests" ON public.freight_proposals FOR SELECT USING ((request_id IN ( SELECT freight_requests.id
   FROM public.freight_requests
  WHERE (freight_requests.client_id = public.get_current_profile_id()))));


--
-- Name: neighborhoods Everyone can view active neighborhoods; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Everyone can view active neighborhoods" ON public.neighborhoods FOR SELECT USING ((is_active = true));


--
-- Name: freight_settings Everyone can view freight settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Everyone can view freight settings" ON public.freight_settings FOR SELECT USING (true);
...
--
-- Name: profiles Instructors can view client profiles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Instructors can view client profiles" ON public.profiles FOR SELECT USING (public.has_role(auth.uid(), 'instructor'::public.app_role));
...
--
-- Name: evolution_photos Instructors can view linked client evolution photos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Instructors can view linked client evolution photos" ON public.evolution_photos FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.instructor_clients ic
  WHERE ((ic.instructor_id = public.get_current_profile_id()) AND (ic.client_id = evolution_photos.profile_id) AND (ic.is_active = true) AND ((ic.link_status)::text = 'accepted'::text)))));
...
--
-- Name: deleted_items_trash Masters can manage trash; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Masters can manage trash" ON public.deleted_items_trash USING (public.is_master(auth.uid())) WITH CHECK (public.is_master(auth.uid()));


--
-- Name: master_credentials Only authenticated masters can manage credentials; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Only authenticated masters can manage credentials" ON public.master_credentials USING (((auth.uid() IS NOT NULL) AND public.is_master(auth.uid()))) WITH CHECK (((auth.uid() IS NOT NULL) AND public.is_master(auth.uid())));


--
-- Name: freight_proposals Providers can manage own proposals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Providers can manage own proposals" ON public.freight_proposals USING ((provider_id = public.get_current_profile_id()));


--
-- Name: provider_vehicles Providers can manage own vehicles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Providers can manage own vehicles" ON public.provider_vehicles USING ((profile_id = public.get_current_profile_id()));


--
-- Name: freight_requests Providers can update accepted requests; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Providers can update accepted requests" ON public.freight_requests FOR UPDATE USING ((accepted_provider_id = public.get_current_profile_id()));


--
-- Name: freight_requests Providers can view open requests; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Providers can view open requests" ON public.freight_requests FOR SELECT USING ((((status)::text = ANY ((ARRAY['pending'::character varying, 'open'::character varying, 'in_negotiation'::character varying])::text[])) OR (accepted_provider_id = public.get_current_profile_id())));
...
--
-- Name: evolution_photos Users can manage own evolution photos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can manage own evolution photos" ON public.evolution_photos USING ((profile_id = public.get_current_profile_id())) WITH CHECK ((profile_id = public.get_current_profile_id()));
...
--
-- Name: freight_messages Users can mark as read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can mark as read" ON public.freight_messages FOR UPDATE USING ((receiver_id = public.get_current_profile_id()));


--
-- Name: freight_messages Users can send messages; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can send messages" ON public.freight_messages FOR INSERT WITH CHECK ((sender_id = public.get_current_profile_id()));
...
--
-- Name: freight_messages Users can view own messages; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own messages" ON public.freight_messages FOR SELECT USING (((sender_id = public.get_current_profile_id()) OR (receiver_id = public.get_current_profile_id())));
...
--
-- Name: deleted_items_trash; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.deleted_items_trash ENABLE ROW LEVEL SECURITY;

--
-- Name: evolution_photos; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: freight_messages; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.freight_messages ENABLE ROW LEVEL SECURITY;

--
-- Name: freight_proposals; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.freight_proposals ENABLE ROW LEVEL SECURITY;

--
-- Name: freight_requests; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.freight_requests ENABLE ROW LEVEL SECURITY;

--
-- Name: freight_settings; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: provider_vehicles; Type: ROW SECURITY; Schema: public; Owner: -
--
