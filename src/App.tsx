...
const FreteHome = lazy(() => import("./pages/FreteHome"));
const Home = lazy(() => import("./pages/Home")); // Mantido para acesso paralelo
      ...
      >
        <Suspense fallback={<PageLoader />}>
          <Routes location={location}>
            <Route path="/" element={<FreteHome />} />
            <Route path="/gym" element={<Home />} /> {/* Acesso paralelo ao sistema fitness */}
